...
public class ArticleByIdDTO {
    ...
    public static ArticleByIdDTO fromArticleIdEntity(Articles articles, Users users){
        return ArticleByIdDTO.builder()
                .id(articles.getId())
                ...
                .getUserInfoDTO(ArticleByIdDTO.GetUserInfoDTO.builder()
                        .id(users.getId())
